...
export class Account {
  ...
  async getUNIRebaseWalletBalance() {
    this.walletInfo["UNIRebase"] = await this.contracts.UNIRebase.methods.balanceOf(this.accountInfo).call();
    return this.walletInfo["UNIRebase"]
  }
